...
function PageMode(props) {
  ...
  return (
    <div className={styles.container}>
      <style>
      @import url('https://fonts.googleapis.com/css2?family=Quicksand:wght@300&family=Raleway:ital,wght@1,200&display=swap');
      </style>
      <AppShell />
      <ButtonBase 
       variant="contained" className={styles.Guess} 
       onClick={()=>{
        setGuess("True");
       }}>
        <video 
